...
const BedroomCard = ({ imgUrl, title, desc, country }) => {
  ...
  return (
    <div
      className={clsx(
        "cursor-pointer relative flex flex-col  justify-start h-[12rem] w-[250px] rounded-lg border border-1 border-zee-border group  hover:border-zee-teal-100 bg-white overflow-hidden p-[0.5rem]",
        styles.container
      )}
    >
