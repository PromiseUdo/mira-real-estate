...
const MoreFilters = () => {
  ...
  return (
    <div id="dropdownButton" className="relative ">
      ...
      {/* dropdown menu */}
      {openDropdown && (
        <div className="  overflow-y-auto max-h-96  rounded border-[1px]  border-zee-border bg-white  absolute top-[50px]  right-0 w-[400px] shadow-md flex flex-col gap-2  scrollbar scrollbar-w-1   scrollbar-track-rounded-lg scrollbar-thumb-rounded-lg scrollbar-thumb-zee-dark-teal-80 scrollbar-track-zee-gray-200">
